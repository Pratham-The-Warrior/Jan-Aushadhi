// ============================================================
// Seller Central — Credential Login Page  (v2 — Polished)
...
import { Store, ArrowRight, Lock, User, Shield } from 'lucide-react';
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 400, width: '100%', position: 'relative', zIndex: 1 }}
        ...
        <div style={{
          ...
          <Shield size={14} style={{ color: 'var(--color-brand-500)' }} />
          <p style={{ fontSize: '0.6875rem', color: 'var(--color-text-muted)', lineHeight: 1.5 }}>
            Secured operator portal. Accounts provisioned by central administrators.
          </p>
        </div>
